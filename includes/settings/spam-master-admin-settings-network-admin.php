<?php
		...
		* Return: void
		*/
		function menu_set_net_single(){
		if ( is_admin() )
		add_submenu_page( 'spam-master', 'Settings', 'Settings', 'manage_options', 'spam-master-settings', 'spam_master_net_settings' );
		}
		...
		///////////////////////
		if( is_multisite() ) {
		add_action( 'network_admin_menu', 'menu_set_net_single' );
		}
		else {
		}

function spam_master_net_settings(){
...
if(!class_exists('spam_master_settings_header_network_admin')){
	require_once( dirname( __FILE__ ) . '/spam-master-admin-settings-header-network-admin.php');
}

//Prepare Table of elements
$wp_list_table = new spam_master_settings_header_network_admin();
//Table of elements
