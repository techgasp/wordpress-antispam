<?php
		...
		* Return: void
		*/
		function menu_fire_net_single(){
		if ( is_admin() )
		add_submenu_page( 'spam-master', 'Firewall', 'Firewall', 'manage_options', 'spam-master-firewall', 'spam_master_firewall_net' );
		}
		...
		///////////////////////
		if( is_multisite() ) {
		add_action( 'network_admin_menu', 'menu_fire_net_single' );
		}
		else {
		}

function spam_master_firewall_net(){
...
if(!class_exists('spam_master_firewall_header')){
	require_once( dirname( __FILE__ ) . '/spam-master-admin-firewall-header-network-admin.php');
}

//Prepare Table of elements
$wp_list_table = new spam_master_firewall_header_network_admin();
//Table of elements
