<?php
add_action( 'init', 'spam_master_warning_trial_email' );
function spam_master_warning_trial_email(){
global $wpdb, $blog_id;
if( is_multisite() ){
...
<p>If you enjoyed the protection you can quickly get a full license, it costs peanuts per year.</p>
...
//set notice
if( is_multisite() ){
	update_blog_option($blog_id, 'spam_master_trial_expired', 'notice');
}
else{
	update_option('spam_master_trial_expired', 'notice');
}
//end func
}
?>
