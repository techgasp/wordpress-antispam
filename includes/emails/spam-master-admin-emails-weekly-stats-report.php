...
$spam_master_emails_weekly_stats_date = get_blog_option($blog_id, 'spam_master_emails_weekly_stats_date');
...
$spam_master_emails_weekly_stats_date = get_option('spam_master_emails_weekly_stats_date');
...
if($response_key == 'EXPIRED'){
	$spam_master_warning = '<li>Warnings: <b>EXPIRED</b></li>';
	$spam_master_warning_signature = '<p>License is EXPIRED.</p>';
	$spam_master_alert_level_deconstructed = 'EXPIRED';
	$spam_master_alert_level_p_text = 'EXPIRED';
	$spam_master_firewall_on_result = 'Offline';
	$spam_master_learning_active_result = 'Offline';
	
}
if($response_key == 'INACTIVE'){
	$spam_master_warning = '<li>Warnings: <b>INACTIVE</b></li>';
	$spam_master_warning_signature = '<p>License is INACTIVE.</p>';
	$spam_master_alert_level_deconstructed = 'INACTIVE';
	$spam_master_alert_level_p_text = 'INACTIVE';
	$spam_master_firewall_on_result = 'Offline';
	$spam_master_learning_active_result = 'Offline';
}
...
//trim key
$spam_license_key_trim = substr($spam_license_key,0,11);
//set date
...
<tr>
<td>
<h2 style="color: #000000; margin:0; padding: 18px 14px; display:block; font-family: &apos;Helvetica Neue&apos;, Helvetica, Arial, &apos;Lucida Grande&apos;, sans-serif; font-size:22px; font-weight: 500; line-height: 1.2;">
'.$spam_master_stats_subject_title.'<br>'.$blogname.'
...
//Email Content
$spam_master_stats_table_content = '<ul>
'.$spam_master_warning.'
<li>Spam Master Type: <b>'.$spam_master_type.'</b></li>
<li>Spam Master Status: <b>'.$response_key.'</b></li>
<li>Spam Master Version: <b>'.$spam_master_version.'</b></li>
<li>Spam Master Key: <b>'.$spam_license_key_trim.'</b></li>
<br>
...
$spam_master_stats_table_footer_content = '<p>Statistics Provided by Spam Master</p>';
...
//Set date option
if( is_multisite() ){
	update_blog_option($blog_id, 'spam_master_emails_weekly_stats_date', $spam_master_emails_current_stats_date);
}
else{
	update_option('spam_master_emails_weekly_stats_date', $spam_master_emails_current_stats_date);
}
}	
}
?>
