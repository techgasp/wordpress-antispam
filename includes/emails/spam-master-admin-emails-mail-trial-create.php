...
$spam_master_lic_hash = get_blog_option($blog_id, 'spam_license_trial');
...
$spam_master_lic_hash = get_option('spam_license_trial');
$spam_master_protection_total_number = get_option('spam_master_protection_total_number');
}
//email user
//set mail html
add_filter( 'wp_mail_content_type', 'spam_master_send_user_notice_trial_created_html' );
function spam_master_send_user_notice_trial_created_html() {
	return 'text/html';
}
...
<ul>
<li>Your License is: <b>'.$spam_master_lic_hash.'</b></li>
<li>Protected Against: <b>'.number_format($spam_master_protection_total_number).' threats</b></li>
</ul>
<p>Your free trial license will expire in 7 days.</p>
<br>
<p>Enjoy.</p>
<p>TechGasp Team</p>';
...
$spam_master_table_footer_content = '<p><a href="https://wordpress.techgasp.com/spam-master-documentation/" target="_blank">Help & Documentation</a></p>';
...
remove_filter( 'wp_mail_content_type', 'spam_master_send_user_notice_trial_created_html' );
?>
