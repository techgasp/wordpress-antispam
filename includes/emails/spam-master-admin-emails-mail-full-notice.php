<?php
add_action( 'init', 'spam_master_full_notice' );
function spam_master_full_notice(){
global $wpdb, $blog_id;
if( is_multisite() ){
...
if( is_multisite() ){
	update_blog_option($blog_id, 'spam_master_full_notice', 'notice');
}
else{
	update_option('spam_master_full_notice', 'notice');
}
}
?>
